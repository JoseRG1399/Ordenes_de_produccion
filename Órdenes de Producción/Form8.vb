...
Public Class Form8
    ...
    Private Sub Llenar_combo()
        Try
            ...
            adaptador = New OleDbDataAdapter("select DISTINCT  Receta from Recetas", conexion3)
            adaptador.Fill(dt)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If ComboBox1.Text = "Cremosos" Then
            Try
                ...
                Try
                    ...
                    cmd = New OleDbCommand("INSERT INTO Pedido_MateriaPrima(Fecha,Departamento,Producto,Cantidad,Unidad) VALUES('" & Label8.Text & "','" & ComboBox1.Text & "','" & ComboBox2.Text & "','" & CDec(TextBox1.Text) & "','" & TextBox2.Text & "')", conexion3)
                    conexion3.Open()
                ...
                Try
                    ...
                    Adaptador11 = New OleDbDataAdapter(buscar11, conexion3)
        ...
        If ComboBox1.Text = "Cremosos" Then
            ...
            Try
                ...
                For Each row11 In DataGridView2.Rows
                    ...
                    cmd = New OleDbCommand("INSERT INTO Pedido_MateriaPrima(Fecha,Departamento,Producto,Cantidad,Unidad) VALUES('" & Label8.Text & "','" & ComboBox1.Text & "','" & TextBox15.Text & "','" & CDec(TextBox20.Text) & "','" & TextBox19.Text & "')", conexion3)
                    conexion3.Open()
                    r1 = cmd.ExecuteNonQuery
                    conexion3.Close()
    ...
    Private Sub Button29_Click(sender As Object, e As EventArgs) Handles Button29.Click
        ...
        If MsgBox("¿Deseas borrar el producto seleccionado?", MsgBoxStyle.YesNo, "Rosa de Sarón Pastelerías") = MsgBoxResult.Yes Then
            ...
            Try
                ...
                cmd15 = New OleDbCommand("delete from Pedido_MateriaPrima where Producto='" & TextBox5.Text & "'", conexion3)
                conexion3.Open()
    ...
    Private Sub Button30_Click(sender As Object, e As EventArgs) Handles Button30.Click
        ...
        If MsgBox("¿Deseas borrar todo el pedido hecho y realizar uno nuevo?", MsgBoxStyle.YesNo, "Rosa de Sarón Pastelerías") = MsgBoxResult.Yes Then
            ...
            Try
                Dim cmd15 As New OleDbCommand
                cmd15 = New OleDbCommand("delete from Pedido_MateriaPrima", conexion3)
                conexion3.Open()
                cmd15.ExecuteNonQuery()
                conexion3.Close()
            Catch ex As Exception
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("CREMOSOS", prFont3, Brushes.Black, 32, 150)
        ...
        If ComboBox1.Text = "Cremosos" Then
            ...
            For Each linea In DataGridView1.Rows
                ...
                Try
                    ...
                    cmd = New OleDbCommand("INSERT INTO Pedido_MateriaPrima_Definitiva(Fecha,Departamento,Producto,Cantidad,Unidad) VALUES('" & TextBox6.Text & "','" & TextBox7.Text & "','" & TextBox8.Text & "','" & CDec(TextBox9.Text) & "','" & TextBox10.Text & "')", conexion3)
                    conexion3.Open()
                    r1 = cmd.ExecuteNonQuery
                    conexion3.Close()
