...
Public Class Form9
    ...
    Private Sub Llenar_combo()
        Try
            ...
            adaptador = New OleDbDataAdapter("select DISTINCT  Receta from Recetas", conexion4)
            adaptador.Fill(dt)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If ComboBox1.Text = "Flanes y arroz" Then
            Try
                ...
                Try
                    ...
                    cmd = New OleDbCommand("INSERT INTO Pedido_MateriaPrima(Fecha,Departamento,Producto,Cantidad,Unidad) VALUES('" & Label8.Text & "','" & ComboBox1.Text & "','" & ComboBox2.Text & "','" & CDec(TextBox1.Text) & "','" & TextBox2.Text & "')", conexion4)
                    conexion4.Open()
                ...
                Try
                    ...
                    Adaptador11 = New OleDbDataAdapter(buscar11, conexion4)
        ...
        If ComboBox1.Text = "Flanes y arroz" Then
            ...
            Try
                ...
                For Each row11 In DataGridView2.Rows
                    ...
                    cmd = New OleDbCommand("INSERT INTO Pedido_MateriaPrima(Fecha,Departamento,Producto,Cantidad,Unidad) VALUES('" & Label8.Text & "','" & ComboBox1.Text & "','" & TextBox15.Text & "','" & CDec(TextBox20.Text) & "','" & TextBox19.Text & "')", conexion4)
                    conexion4.Open()
                    r1 = cmd.ExecuteNonQuery
                    conexion4.Close()
        ...
        If e.KeyCode = Keys.Enter Then
            ...
            If ComboBox1.Text = "Flanes y arroz" Then
                ...
                Try
                    ...
                    Dim row11 As DataGridViewRow
                    For Each row11 In DataGridView1.Rows
                        row11.Height = 30
    ...
    Private Sub Button29_Click(sender As Object, e As EventArgs) Handles Button29.Click
        ...
        If MsgBox("¿Deseas borrar el producto seleccionado?", MsgBoxStyle.YesNo, "Rosa de Sarón Pastelerías") = MsgBoxResult.Yes Then
            ...
            Try
                ...
                cmd15 = New OleDbCommand("delete from Pedido_MateriaPrima where Producto='" & TextBox5.Text & "'", conexion4)
                conexion4.Open()
    ...
    Private Sub Button30_Click(sender As Object, e As EventArgs) Handles Button30.Click
        ...
        If MsgBox("¿Deseas borrar todo el pedido hecho y realizar uno nuevo?", MsgBoxStyle.YesNo, "Rosa de Sarón Pastelerías") = MsgBoxResult.Yes Then
            ...
            Try
                Dim cmd15 As New OleDbCommand
                cmd15 = New OleDbCommand("delete from Pedido_MateriaPrima", conexion4)
                conexion4.Open()
                cmd15.ExecuteNonQuery()
                conexion4.Close()
            Catch ex As Exception
    ...
    Private Sub PrintDocument1_PrintPage(sender As Object, e As Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        e.Graphics.DrawString("FLANES/ARROZ", prFont3, Brushes.Black, 32, 150)
        ...
        If ComboBox1.Text = "Flanes y arroz" Then
            ...
            For Each linea In DataGridView1.Rows
                ...
                Try
                    ...
                    cmd = New OleDbCommand("INSERT INTO Pedido_MateriaPrima_Definitiva(Fecha,Departamento,Producto,Cantidad,Unidad) VALUES('" & TextBox6.Text & "','" & TextBox7.Text & "','" & TextBox8.Text & "','" & CDec(TextBox9.Text) & "','" & TextBox10.Text & "')", conexion4)
                    conexion4.Open()
                    r1 = cmd.ExecuteNonQuery
                    conexion4.Close()
